#THIS PROGRAM TAKES A PHOTO OF A LICENSE PLATE OF A VEHICLE/ PHOTO
#AND RUNS IT THROUGH THE SYSTEM
#IDEALLY SHOULD RUN MULTIPLE TIMES AUTOMATICALLY FOR MULTIPLE VEHICLES
...
def camera():
    ...
    while True:
        ...
        if k % 256 == 27:
            ...
            rame = cv2.imwrite(img_name, frame)
